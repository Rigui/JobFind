...
def crear_usuarios():
    ...
    user1 = Users.Users('Pablo', 'Domínguez Malleiro',"usuario1@eweb.com")
    user2 = Users.Users('Rigui', 'Rigueira Cabrera',"usuario2@eweb.com")
    user3 = Users.Users('Alex', 'Martín Merino',"usuario3@eweb.com")
    user4 = Users.Users('Alberto', 'González Cristobo',"usuario4@eweb.com")
    user5 = Users.Users('Barack', 'Obama',"usuario5@eweb.com")
    user6 = Users.Users('Casius', 'Clay',"usuario6@eweb.com")
    users = [
